...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('users/{user}', [ParentChildProfileController::class, 'show'])->name('athletes.show');
    ...
    Route::put('users/{user}/password', [ParentChildProfileController::class, 'updatePassword'])->name('users.password.update');
