...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('users/{user}', [AdminManagementController::class, 'show'])->name('athletes.show');
    Route::post('users/{user}/profile', [AdminManagementController::class, 'updateAccountProfile'])->name('users.profile.update');
    Route::put('users/{user}/athlete-profile', [AdminManagementController::class, 'updateAthleteProfile'])->name('users.athlete-profile.update');
    ...
    Route::post('users/{user}/certifications', [AdminManagementController::class, 'storeUserCertification'])->name('users.certifications.store');
    Route::put('users/{user}/certifications/{certification}', [AdminManagementController::class, 'updateUserCertification'])->name('users.certifications.update');
    Route::post('users/{user}/achievements', [AdminManagementController::class, 'storeUserAchievement'])->name('users.achievements.store');
    Route::put('users/{user}/achievements/{achievement}', [AdminManagementController::class, 'updateUserAchievement'])->name('users.achievements.update');
