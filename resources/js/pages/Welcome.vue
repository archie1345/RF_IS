    ...
    <main class="min-h-screen bg-neutral-950 text-white">
            ...
            <div class="relative z-10 flex w-full flex-col">
                ...
                >
                    <div>
                        ...
                        <p class="mb-4 text-sm font-semibold tracking-[0.28em] text-red-300 uppercase">RF IS</p>
        ...
        <section class="border-t border-white/10 bg-neutral-950 px-5 py-10 sm:px-8 lg:py-14">
            <div class="mx-auto grid max-w-7xl gap-4 md:grid-cols-[1.1fr_2fr]">
                <div class="max-w-xl">
                    <p class="text-sm font-semibold text-red-300 uppercase">Club command center</p>
                ...
                <div class="grid gap-4 md:grid-cols-3">
                    ...
                    >
                        <p class="mb-4 text-xs font-semibold tracking-[0.22em] text-red-300 uppercase">
                            0{{ index + 1 }}
                        </p>
