...
const highlights = [
    ...
    { title: 'Keuangan & kompetisi', detail: 'Tagihan, payroll, kejuaraan, UKT, serta bukti pembayaran tersimpan rapi.' },
];
</script>
...
<template>
    ...
    <main class="min-h-screen bg-neutral-950 text-white">
        <section class="flex min-h-[78svh] flex-col border-b border-white/10">
            ...
            <div class="mx-auto grid w-full max-w-7xl flex-1 items-center gap-10 px-5 py-14 sm:px-8 lg:grid-cols-[1fr_0.56fr]">
                <div>
                    ...
                    <p class="mt-5 max-w-2xl text-base leading-7 text-neutral-300 sm:text-lg">
                        Satu tempat untuk profil atlet, jadwal latihan, presensi, pembayaran, payroll, pengumuman, UKT, dan kejuaraan.
                    </p>
                ...
                <div class="grid gap-4 border-l border-white/15 pl-6 lg:pl-8">
                    <article v-for="(item, index) in highlights" :key="item.title" class="border-b border-white/15 pb-4 last:border-0 last:pb-0">
        ...
        <footer class="mx-auto flex w-full max-w-7xl flex-col gap-2 px-5 py-8 text-sm text-neutral-400 sm:px-8 sm:flex-row sm:items-center sm:justify-between">
