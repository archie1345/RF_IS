...
const activationHint = computed(() => {
    ...
    return isPrivateClass.value
        ? 'Lengkapi nama, tipe private, minimal satu atlet private, coach private, lokasi aktif, jadwal/tanggal, jam mulai, dan jam selesai.'
            ...
            <FormModal :open="showClassForm" max-width-class="max-w-3xl" @close="closeClassForm">
                <form class="grid gap-4" @submit.prevent="saveClass">
                    ...
                    <p class="mt-1 text-sm text-muted-foreground">
                        Pilih Tipe Kelas terlebih dahulu. Jika Private, kategori atlet disembunyikan dan presensi hanya untuk atlet private yang dipilih.
                    </p>
