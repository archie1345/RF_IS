...
<template>
    <div class="space-y-6">
        ...
        <div
            class="dark:border-brand-coral/30/10 space-y-4 rounded-lg border border-red-100 bg-brand-coral/10 p-4 dark:bg-red-700/10"
        >
            <div class="relative space-y-0.5 text-brand-coral dark:text-brand-coral/80">
