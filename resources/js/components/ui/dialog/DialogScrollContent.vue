  ...
  <DialogPortal>
    ...
    >
      <DialogContent
        :class="
          cn(
            'relative z-50 my-8 grid w-full max-w-[calc(100%-1.5rem)] gap-4 rounded-xl border border-border/70 bg-card p-4 shadow-xl duration-200 sm:max-w-xl sm:p-6 md:w-full',
            props.class,
          )
        "
